...
const navigation = [
  ...
  { name: 'New Post', href: '/dashboard/posts/new', current: false },
...
export default function Navbar() {
  //On the server, you cannot get the full dynamic URL of the browser because the server renders the component before it knows where the user might navigate.
  return (
    <Disclosure
      as="nav"
